...
<div id="addform">
	<form onsubmit="return checkForm(this)" action="<?php echo URL::base();?>admin/invnumbers/update" method="POST" name="editform" id="editform">
		...
		<div class="table">
				...
				<div class="table-row">
					...
					<div class='table-cell no-border input'><input type='text' name='book_id' id='book_id' value="<?php echo $book_id?>"/></div>
				</div>
