<!-- Fueltypes index -->
<span class="tab_title">Редактор типів дивгунів (за пальним)<hr></span>
<style type="text/css">
#newscontainer {
...
<div class="table" id="table_id">
	...
	foreach ($data as $fueltype) {
		$edit_link = URL::site("admin/fueltypes/edit")."/".$fueltype->fueltype_id;
		echo "<div class=\"table-row\">\n";
		echo "<div class=\"table-cell text-center\">{$fueltype->fueltype_id}</div>\n";
		echo "<div class=\"table-cell\">{$fueltype->fueltype_name}</div>\n";
...
<div class="addhref"><a class="add_button">Додати новий тип пального</a></div>
